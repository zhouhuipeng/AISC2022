...
parser.add_argument('--root_path', type=str,
                    default='/home/nas928/dataset/CASIA/CASIA-WebFace-112X96/', help='path to root path of images')
...
parser.add_argument('--save_path', type=str, default='ckdim/',
...
if args.database is 'WebFace':
    args.train_list = '/home/nas928/dataset/CASIA/CASIA-WebFace-112X96.txt'
...
def main():
    ...
    ckpt = '/home/sshfs928/zhp/FaceModelZOO_pytorch-master-final/Fusing_Attack/ckpts/CosFace_pytorch/ACC99.28.pth'#   98.45   CosFace_2_checkpoint.pth
    state_dict = torch.load(ckpt)
    stat = {}
    for key, val in state_dict.items():
        stat.setdefault("module."+key, val)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        model.module.save(args.save_path + 'CosFace_' +
                          str(epoch) + '_checkpoint.pth')
        print(args.save_path + 'CosFace_' +
                      str(epoch) + '_checkpoint.pth')
        lfw_eval.callmain( args.save_path + 'CosFace_' +
                      str(epoch) + '_checkpoint.pth')
    ...
    for batch_idx, (data, target) in enumerate(train_loader, 1):
        ...
        if batch_idx % args.log_interval == 0:
            ...
            if args.classifier_type is 'MCP':
                INFO = ' Margin: {:.4f}, Scale: {:.2f}'.format(
                    classifier.m, classifier.s)
